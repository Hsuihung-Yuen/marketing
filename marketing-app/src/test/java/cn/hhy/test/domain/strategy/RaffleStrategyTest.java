...
import cn.hhy.domain.strategy.service.rule.chain.impl.RuleWeightLogicChain;
import cn.hhy.domain.strategy.service.rule.tree.impl.RuleLockLogicTreeNode;
...
public class RaffleStrategyTest {
    ...
    /**
     * 次数错校验，抽奖n次后解锁。100003 策略，可以通过调整 @Before 的 setUp 方法中个人抽奖次数来验证。比如最开始设置0，之后设置10
