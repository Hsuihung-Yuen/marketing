...
public abstract class AbstractRaffleStrategy implements IRaffleStrategy {
    ...
    public RaffleAwardEntity performRaffle(RaffleFactorEntity raffleFactorEntity) {
        ...
        if (null != ruleActionEntity && RuleLogicCheckTypeVO.TAKE_OVER.getCode().equals(ruleActionEntity.getCode())) {
        ...
        if (null != ruleActionCenterEntity && RuleLogicCheckTypeVO.TAKE_OVER.getCode().equals(ruleActionCenterEntity.getCode())){
