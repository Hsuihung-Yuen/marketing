...
import cn.hhy.domain.activity.event.ActivitySkuStockZeroMessageEvent;
...
public class ActivityRepository implements IActivityRepository {
    ...
    public ActivitySkuEntity queryActivitySku(Long sku) {
        ...
        if (null == cacheSkuStock || 0 == cacheSkuStock) {
            cacheSkuStock = Long.valueOf(raffleActivitySku.getStockCountSurplus());
        }
    ...
    public ActivityAccountEntity queryActivityAccountEntity(Long activityId, String userId) {
        // 1. 查询总账户额度
        RaffleActivityAccount raffleActivityAccount = raffleActivityAccountDao.queryActivityAccountByUserId(
                RaffleActivityAccount.builder()
                    .activityId(activityId)
                    .userId(userId)
                    .build()
