...
import cn.hhy.domain.activity.service.IRaffleActivityPartakeService;
...
import cn.hhy.domain.rebate.service.IBehaviorRebateService;
...
/**
 * @author Hhy
 * @description 抽奖活动服务，在不引用 application/case 层的时候，就需要让接口实现层来做领域的串联
 * @create 2024/7/20
 */
...
public class RaffleActivityController implements IRaffleActivityService {
     ...
     * @return 装配结果
     *
     * 接口：<a href="http://localhost:8091/api/v1/raffle/activity/armory" />
     * 入参：{"activityId":100001,"userId":"hhy"}
     *
     * apipost的curl注入
     * curl --request GET --url 'http://localhost:8091/api/v1/raffle/activity/armory?activityId=100301'
     */
    ...
    public Response<Boolean> creditPayExchangeSku(@RequestBody SkuProductShopCartRequestDTO request) {
        try {
            ...
            UnpaidActivityOrderEntity unpaidActivityOrder = raffleActivityAccountQuotaService.createOrder(
